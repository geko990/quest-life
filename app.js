    ...
    container.innerHTML = habitsToShow.map(habit => {
        ...
        return `
            <div class="task-card ${habit.locked ? 'locked' : ''}" data-type="habit" data-id="${habit.id}">
                <div class="swipe-actions swipe-actions-left">
                    <button class="swipe-action" onclick="editTask('habit', '${habit.id}')">✏️</button>
                </div>
                <div class="swipe-actions swipe-actions-right">
                    <button class="swipe-action" onclick="deleteTask('habit', '${habit.id}')">🗑️</button>
                </div>
    ...
    container.innerHTML = pending.map(oneshot => {
        ...
        return `
            <div class="task-card ${oneshot.locked ? 'locked' : ''}" data-type="oneshot" data-id="${oneshot.id}">
                <div class="swipe-actions swipe-actions-left">
                    <button class="swipe-action" onclick="editTask('oneshot', '${oneshot.id}')">✏️</button>
                </div>
                <div class="swipe-actions swipe-actions-right">
                    <button class="swipe-action" onclick="deleteTask('oneshot', '${oneshot.id}')">🗑️</button>
                </div>
    ...
    container.innerHTML = active.map(quest => {
        ...
        return `
            <div class="task-card quest-card ${quest.locked ? 'locked' : ''}" data-type="quest" data-id="${quest.id}">
                <div class="swipe-actions swipe-actions-left">
                    <button class="swipe-action" onclick="editTask('quest', '${quest.id}')">✏️</button>
                </div>
                <div class="swipe-actions swipe-actions-right">
                    <button class="swipe-action" onclick="deleteTask('quest', '${quest.id}')">🗑️</button>
                </div>
